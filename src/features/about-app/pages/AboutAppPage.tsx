...
const aboutAppContent: Record<Language, AboutAppContent> = {
  el: {
    ...
    areasTitle: 'Βασικές λειτουργικές περιοχές',
    areasLead:
      'Οι έξι περιοχές είναι εσωτερικά λειτουργικά και θεματικά όρια για την ιδιοκτησία των εγγραφών. Δεν αποτελούν το δέντρο πλοήγησης της πλαϊνής μπάρας.',
    areas: [
      ...
      { title: 'Νομοθεσία, Συμμόρφωση και Διακυβέρνηση', text: 'Απαιτήσεις, ευθύνες, αποφάσεις και διοικητική εποπτεία.' },
      { title: 'Εκθέσεις και Αναφορές', text: 'Συγκεντρωτική πληροφόρηση από τις έγκυρες εγγραφές των αρμόδιων ενοτήτων.' },
    ],
    implementedTitle: 'Τι λειτουργεί σήμερα',
    implemented: [
      'Δίγλωσσο και responsive κέλυφος με Αρχική, Επισκόπηση και εγκεκριμένες σελίδες-εισόδους πλοήγησης.',
      'Επιλογή και αποθήκευση γλώσσας με ενημέρωση της γλώσσας του εγγράφου.',
      'Ρυθμίσεις εμφάνισης για μέγεθος κειμένου, υψηλή αντίθεση και μείωση κίνησης.',
    ...
    pending: [
      'Πραγματική καθολική αναζήτηση στο περιεχόμενο της εφαρμογής.',
      'Πλήρεις λειτουργικές ροές εργασίας, εγγραφές Κάλυψης και ολοκληρωμένη γραπτή εκτίμηση κινδύνου.',
      'Backend, βάση δεδομένων και μόνιμη αποθήκευση επιχειρησιακών εγγραφών.',
      'Ταυτοποίηση, εξουσιοδότηση, πρόσβαση βάσει ρόλων και ασφαλές ιστορικό ενεργειών.',
  ...
  en: {
    ...
    areasTitle: 'Core functional areas',
    areasLead:
      'The six areas are internal functional and domain boundaries for record ownership. They are not the sidebar navigation tree.',
    areas: [
      ...
      { title: 'Legislation, Compliance and Governance', text: 'Requirements, accountability, decisions and Management oversight.' },
    ...
    implemented: [
      'A bilingual, responsive shell with Home, Overview and the approved navigation landing pages.',
      'Language selection and persistence, including document-language updates.',
      'Appearance settings for text size, high contrast and reduced motion.',
    ...
    pending: [
      'Real global search across application content.',
      'Complete operational workflows, Coverage records and a complete written risk-assessment workflow.',
      'A backend, database and persistent storage for operational records.',
      'Authentication, authorization, role-based access and audit history.',
