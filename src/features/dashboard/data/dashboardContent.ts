...
export const dashboardContent = {
  el: {
    ...
    nav: [
      ...
      ['shield', 'Νομοθεσία, Συμμόρφωση και Διακυβέρνηση', 'Απαιτήσεις, ευθύνες και διοικητική εποπτεία'],
  ...
  en: {
    ...
    nav: [
      ...
      ['shield', 'Legislation, Compliance and Governance', 'Requirements, responsibilities and Management oversight'],
