...
export const dashboardContent = {
  el: {
    ...
    nav: [
      ...
      ['reports', 'Εκθέσεις και Αναφορές', 'Συγκεντρωτική πληροφόρηση από τα αρχεία προέλευσης'],
      ['settings', 'Ρυθμίσεις'],
    ...
    tasks: [
      ...
      { day: '02', month: 'ΙΟΥΛ', title: 'Περιοδική αναφορά Διεύθυνσης', detail: 'Εκθέσεις και Αναφορές · Κενά κάλυψης και εκπρόθεσμα μέτρα', status: '11:00' },
    ],
